...
export default function PharmacistView({ onBack }: PharmacistViewProps) {
    ...
    return (
      <div className="p-6 space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">Pharmacist Portal</h1>
          <p className="text-gray-600">PharmaCare Malaysia</p>
          <p className="text-sm text-gray-500">Licensed Pharmacist: Pn. Fatimah Abdul</p>
        </div>

        {/* Info Box */}
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-green-800 text-sm">
            Scan prescription QR codes to verify and fulfill patient medications securely.
          </p>
        </div>

        {/* Scan Button */}
        <div className="text-center">
          <Button onClick={handleScanQR} className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Metformin 500mg dispensed</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Prescription verified</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900">Lisinopril 10mg dispensed</p>
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <Button className="w-full bg-green-600 hover:bg-green-700">Mark as Fulfilled</Button>
    </div>
  )
}
