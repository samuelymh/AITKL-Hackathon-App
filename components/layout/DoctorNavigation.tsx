...
import { LayoutDashboard, User, Settings, ArrowLeft, ChevronRight, Stethoscope } from "lucide-react";
...
const doctorNavItems: NavItem[] = [
  {
    ...
    description: "Main doctor dashboard with patient authorizations and activities",
  },
  {
    href: "/dashboard/doctor/professional-profile",
...
export function DoctorNavigation({ className, variant = "sidebar" }: DoctorNavigationProps) {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto p-6">
        ...
        <div className="mb-6 space-y-4">
          ...
          {/* Navigation */}
          <DoctorNavigation variant={navigationVariant} />
        ...
        <div className="flex gap-6">
          {navigationVariant === "sidebar" && <DoctorNavigation variant="sidebar" className="flex-shrink-0" />}
