...
import PrescriptionQueue, { doctorActions, type PrescriptionRequest } from "@/components/healthcare/PrescriptionQueue";
...
const DoctorPrescriptionsView: React.FC = () => {
  ...
  const doctorPrescriptionActions = doctorActions.map((action) => ({
    ...action,
    onClick:
      action.id === "edit"
