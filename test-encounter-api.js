...
const runTests = async () => {
  ...
  console.log(`   Expected: 400 or 401 (auth required) - Got: ${[400, 401, 403].includes(postEncounterResult.status) ? '✅' : '❌'}`);
  ...
  console.log(`   Expected: 400 or 401 (auth required) - Got: ${[400, 401, 403].includes(getEncounterResult.status) ? '✅' : '❌'}`);
  ...
  console.log(`   Expected: 400 or 401 (auth required) - Got: ${[400, 401, 403].includes(putEncounterResult.status) ? '✅' : '❌'}`);
