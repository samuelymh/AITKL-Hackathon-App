          ...
          $project: {
            ...
            notes: {
              $switch: {
                branches: [
                  {
                    case: { $eq: ["$grantDetails.status", "ACTIVE"] },
                    then: "Access granted - Active authorization",
                  },
                  {
                  ...
                  {
                    case: { $eq: ["$grantDetails.status", "EXPIRED"] },
                    then: "Authorization expired",
                  },
                  {
                    case: { $eq: ["$grantDetails.status", "REVOKED"] },
                    then: "Authorization revoked",
                  },
                ],
